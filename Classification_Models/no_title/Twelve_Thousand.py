...
svm_training_and_testing, svm_classifier =training_and_testing(svm_classifier,X_train, y_train,X_test,y_test,
                                              "results/svm12k_unsuccessful_results.txt","results/svm12k_successful_results.txt",df)
#printing of training and testing results
with open('training_testing/svm12k_training_and_testing.txt', 'w') as file:
...
joblib.dump(xgb_classifier, 'models/xgb_model_12k.pkl')
...
validate('models/xgb_model_12k.pkl', X_unseen, y_unseen, 'validated/xgb12k_validated.txt')
